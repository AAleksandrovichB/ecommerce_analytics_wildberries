...
Анализ по 16 артикулам с известной себестоимостью (из 34).

| Группа | Артикулов | Доля прибыли | Маржа (диапазон) |
|---|---|---|---|
| A | 6 | 79.5% | до 67.7% |
| B | 4 | 15.4% | — |
| C | 6 | 5.2% | от 28.2% |

Все 16 артикулов прибыльны. Общая прибыль по анализируемым артикулам — **54.3 млн ₽**.
...
Analysis across 16 SKUs with known cost price (out of 34 total).

| Group | SKUs | Profit Share | Margin Range |
|---|---|---|---|
| A | 6 | 79.5% | up to 67.7% |
| B | 4 | 15.4% | — |
| C | 6 | 5.2% | from 28.2% |

All 16 SKUs are profitable. Total profit across analysed SKUs — **54.3M ₽**.
